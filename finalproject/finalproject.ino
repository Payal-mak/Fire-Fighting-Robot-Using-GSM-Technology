...
int status = true;
String alertMsg;
String mob1="+919054293225";           // Enter first mobile number with country code
String mob2="+919157377077";           // Enter second mobile number with country code
...
{
  Serial.println("Sending message to: " + mob);
